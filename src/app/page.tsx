...
import {movieToElement} from "@/lib/utils";
...
export default async function Home() {
    ...
    const popularMovies: TMDBResponse<Movie> = await getPopularMovies();
    const popularMoviesElements: ElementInterface[] = popularMovies.results.map((movie) => movieToElement(movie, configuration, 175, 175 * 1.5, true, false, false));
    return (
